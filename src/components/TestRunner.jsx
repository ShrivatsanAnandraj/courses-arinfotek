    ...
    <div className="w-full max-w-4xl mx-auto">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 overflow-hidden">
        ...
        <div className="p-3 sm:p-5 md:p-7">
          <div className="w-full bg-slate-100 dark:bg-slate-700 rounded-full h-1.5 sm:h-2 mb-3 sm:mb-5">
            <div
          ...
          <div className="mb-4 sm:mb-6">
            <div className="flex items-start gap-2 sm:gap-3 mb-4 sm:mb-6">
              ...
              <h2 className="text-[15px] sm:text-lg font-semibold text-slate-800 dark:text-slate-100 leading-snug">{current.question_text}</h2>
            </div>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2.5 px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl border-2 text-left transition-all cursor-pointer ${
                      isSelected
                        ...
                        : 'border-slate-100 hover:border-slate-300 hover:bg-slate-50 dark:border-slate-700 dark:hover:border-slate-600 dark:hover:bg-slate-700'
                    }`}
                  >
                    <span
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <button
              ...
              disabled={isFirst}
              className="px-4 py-2 sm:py-2.5 rounded-lg font-bold text-xs sm:text-sm border-2 border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-30 disabled:cursor-not-allowed transition"
            >
              Previous
            </button>
        ...
        <div className="border-t border-slate-100 dark:border-slate-700 px-3 sm:px-5 py-2.5 sm:py-3.5">
          <div className="text-[11px] sm:text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 sm:mb-2">Question Palette</div>
              ...
              <button
                ...
                className={`w-7 h-7 sm:w-9 sm:h-9 rounded-md sm:rounded-lg text-[11px] sm:text-xs font-bold transition ${
                  i === currentIndex
                    ...
                    ? 'bg-green-100 text-green-700 border border-green-200 dark:bg-green-900/60 dark:text-green-300 dark:border-green-800'
                    : 'bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-slate-300 hover:bg-slate-200'
                }`}
              >
                {i + 1}
              </button>
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm overflow-y-auto p-4">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-5 sm:p-8 max-w-sm w-full mx-auto my-auto text-center">
            <div className="w-14 h-14 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-7 h-7 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
              </svg>
            </div>
            <h3 className="text-lg font-black text-slate-800 dark:text-slate-100 mb-2">Are you sure you want to submit?</h3>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2.5 rounded-lg font-bold text-sm border-2 border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition"
              >
                No
              </button>
              <button
